...
namespace social_net_service::post
{
    ...
    {
    public:
        static constexpr std::string_view kName = "handler-post-create";

        PostCreateHandler(const userver::components::ComponentConfig&, const userver::components::ComponentContext&);
